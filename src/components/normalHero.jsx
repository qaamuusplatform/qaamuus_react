    ...
    return (
        ...
        <section className="masthead -type-2">
            <div className="masthead__bg">
                <div className="bg-image js-lazy" data-bg="img/home-3/masthead/bg.png" />
            </div>
                    ...
                    <div className="col-xl-6 col-lg-11">
                        <div className="masthead__content">
                            ...
                            <div className="masthead__button mt-20">
                                <a href="courses-list-1.html" className="button -md -white text-dark-1">Find Courses</a>
                            </div>
                        </div>
                    </div>
                    <div className="col-xl-5 col-lg-11">
                        ...
                        <div className="masthead-form">
                            ...
                            <form action="#">
                                ...
                                <div className="masthead-form__group">
                                    <button type="submit" className="button -md -purple-1 text-white">Start Learning For Free</button>
                                </div>
